...
public class ClientsTransportationActivity extends AppCompatActivity implements AddTransportationInterface, TransportationsAdapter.ArrivedClickListener, ArrivedTransportationInterface {
    ...
    public void getAllTransportations(){
        ...
        String url = Config.TEST_CLIENTSORDERSTRANSPOTATION_URL;
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    for(int i=0;i<sizeofarray;i++){
                        ...
                        Driver d= new Driver(jObj.get("name").toString(), jObj.get("mobile").toString(),jObj.get("address").toString(), jObj.get("cost").toString(), jObj.get("status").toString());
    ...
    public void onArrivedClickListener(RecyclerView.ViewHolder viewHolder, int itemPosition) {
        ...
        ArrivedClientTransportationFragment fr = new ArrivedClientTransportationFragment();
        fr.setArguments(b);
        fr.setListener(this);
    ...
    public void Add(View view) {
        AddClientTransportation fr = new AddClientTransportation();
        fr.setListener(this);
