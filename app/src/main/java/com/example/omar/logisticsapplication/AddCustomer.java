...
public class AddCustomer extends DialogFragment {
    ...
    private AddCustomerInterface mListener;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        add_user=view.findViewById(R.id.add_customer);
    ...
    public void setListener(AddCustomerInterface listener) {
        mListener = listener;
    }
    ...
    private void registerUser(final String name, final String email,
        ...
        String url = Config.TEST_ADDCUSTOMER_URL;
