...
public class ArrivedTransportationFragment extends DialogFragment {
    ...
    public ArrivedTransportationFragment() {
    ...
    private void arrivedTransportationDB(final String orderNo, final Driver driver) {
        ...
        String url = Config.TEST_ARRIVEDSUPPLIERSTRANSPOTATIONS_URL;
