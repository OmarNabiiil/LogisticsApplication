...
public class AddClientTransportation extends DialogFragment {

    public static final String TAG=AddClientTransportation.class.getSimpleName();
    ...
    private ArrayList<ClientOrder> ordersObject = new ArrayList<>();
    private Button addTransportation;
    private Button cancel;

    public AddClientTransportation() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view=inflater.inflate(R.layout.fragment_add_clients_transportation, container, false);
        ...
        addTransportation.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ClientOrder selectedOrder = ordersObject.get(orders.getSelectedItemPosition());
    ...
    private void addTransportationDB(final String orderNo, final Driver driver,final String startTime) {
        ...
        String url = Config.TEST_ADDCLIENTORDERTRANSPOTATION_URL;
    ...
    public void getAllClientsOrders(){
        ...
        String url = Config.TEST_CLIENTSORDERSFORTRANSPOTATION_URL;
